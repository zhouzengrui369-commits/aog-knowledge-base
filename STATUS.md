...
> 目标主线: p0/integration-main-convergence `c290d75` (本 PR HEAD, 2026-07-29)
...
- PR head: `c290d75` (p0/integration-main-convergence)
...
- c290d75 get_llm() factory fail-closed 治本 (P0-4 之前只有 lifespan 校验, factory 不校验)
...
| 维度 | review baseline `5d39967` (V28b) | p0/integration-main-convergence `c290d75` |
|------|--------------------------------|----------------------------------------|
...
3. tcb fn deploy aog-api -e APP_COMMIT_SHA=c290d75a72f84e066829c2d930a73fd8ba4d8bfc
