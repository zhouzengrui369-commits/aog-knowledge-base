...
async def seeded_sqlite():
    ...
    async with sqlite.session_factory() as session:
        ...
        session.add(CityRow(
            ...
            data_json='{"iata":"PKX","pinyin":"beijingdaxing","tags":["AOG预案","国际枢纽"],"fleet":[{"model":"B787","short_stay":false,"after":false}],"parts":[{"pn":"C20649000","name":"B787 主轮","stock":0,"unit":"个"}],"contacts":[{"org":"东航","phone":["021-22379771"],"role":"7×24"}],"warehouse":{"location":"北京大兴东航机务区","main":["B787 主轮"]},"logistics":{"rail":"京沪高铁","air":"国内 6h","road":"京津冀 4h"},"content_md":"# 北京大兴\\n\\n国际枢纽...","source_path":"02_外战预案/B-北京大兴.md","updated_at":"2026-07-15T00:00:00"}',
        ...
        session.add(CityRow(
            ...
            data_json='{"iata":"PVG","pinyin":"shanghaipudong","tags":["AOG预案","国内最大"],"fleet":[],"parts":[],"contacts":[],"warehouse":{"location":"浦东东航机务","main":[]},"logistics":{"rail":"沪宁","air":"4h","road":"长三角"},"content_md":"# 上海浦东\\n\\n国内最大...","source_path":"02_外战预案/S-上海浦东.md","updated_at":"2026-07-15T00:00:00"}',
            updated_at=datetime.utcnow(),
        ))
        session.add(CityRow(
            code="B-包头",
            ...
            iata="BAV",
            pinyin="baotou",
            data_json='{"iata":"BAV","pinyin":"baotou","tags":[],"fleet":[],"parts":[],"contacts":[],"warehouse":{"location":"","main":[]},"logistics":{"rail":"","air":"","road":""},"content_md":"包头暂停","source_path":"02_外战预案/B-包头.md","updated_at":"2026-07-15T00:00:00"}',
            updated_at=datetime.utcnow(),
        ))
        ...
        session.add(ExperienceRow(
            ...
            category="案例",
            status="现行",
            data_json='{"tags":["B787","风挡","案例"],"summary":"B787 风挡 AOG 标准流程","content_md":"# B787 风挡\\n\\n流程内容...","related_pn":[],"source_path":"03_保障经验/exp-001.md","updated_at":"2026-07-15T00:00:00"}',
            updated_at=datetime.utcnow(),
        ))
        session.add(ExperienceRow(
            id="exp-002",
            ...
            category="案例",
            status="现行",
            data_json='{"tags":["BMS9-3","玻璃纤维布"],"summary":"BMS9-3 储存与施工经验","content_md":"# BMS9-3\\n\\n储存方法...","related_pn":["BMS9-3"],"source_path":"03_保障经验/exp-002.md","updated_at":"2026-07-14T00:00:00"}',
            updated_at=datetime.utcnow(),
        ))
        ...
        session.add(CorePlanRow(
            ...
            type="master",
            data_json='{"content_md":"# 核心预案\\n\\n主预案...","source_path":"01_AOG预案/2026-02-04.md","updated_at":"2026-02-04T00:00:00"}',
            updated_at=datetime.utcnow(),
        ))
